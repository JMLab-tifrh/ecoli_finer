...
$python genRepFork.py pol.gro # generating replication fork
echo "========================================================"

# 3. generation of force-field files
echo "========================================================"
echo "generating force field files"
$python gentopol.py pol_fork.gro 1.0 
echo "========================================================"
...
# 5. inserting ribosomes and polysomes
echo "========================================================"
$gmx insert-molecules -f em1.gro -ci polysome.gro -nmol 1292 -o temp1.gro
$gmx insert-molecules -f temp1.gro -ci monomer30S.gro -nmol 2102 -o temp2.gro
$gmx insert-molecules -f temp2.gro -ci monomer50S.gro -nmol 2102 -o conf.gro
echo "========================================================"
...
echo "========================================================"
$python gentopol.py pol_fork.gro 1.0 1.0
echo "========================================================"
